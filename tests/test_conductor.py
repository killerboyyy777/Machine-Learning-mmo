...
cm_os._recent_goals.append(_parent289)
with _mock289.patch.object(_churn289, "OFFSPRING_FRACTION", 1.0):
    _kids289 = [cm_os._sample_goal() for _ in range(50)]
...
with _mock289.patch.object(_churn289, "OFFSPRING_FRACTION", 0.0):
    _fresh289 = [cm_os._sample_goal() for _ in range(50)]
